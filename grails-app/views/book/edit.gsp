    ...
    <div class="row mt-4">
        ...
        <div class="col-xl-9">
            ...
            <p class="text-muted mb-5">
                Update catalog information, sales
                settings and digital access.
            </p>
            ...
            <g:uploadForm
                ...
                <section class="admin-form-section">
                    ...
                    <p class="text-muted">
                        ...
                        This stock is for sales only.
                        Lending inventory is managed
                        separately through Book Copies.
