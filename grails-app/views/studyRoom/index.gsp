...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#list-studyRoom" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="list-studyRoom" class="col-12 content scaffold-list" role="main">
                <h1>
                ...
                <f:table class="scaffold table table-striped table-sm" controller="studyRoom" collection="${studyRoomList}"/>

                <g:if test="${studyRoomCount > params.int('max')}">
                    <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        <g:paginate activeClass="active" class="btn" total="${studyRoomCount ?: 0}" />
                    </div>
                </g:if>
            </div>
        </section>
